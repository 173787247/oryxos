...
- dept·project 多级 / `parent_team_id` / OIDC group→org JIT（#554 organizations + `teams.org_id`；#548/#556 Admin；#558 WORKSPACE `orgOwner`；#560 session `orgIds` 缓存 opt-in；相关 API/UI 仍默认关）
