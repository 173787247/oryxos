...
- [ ] T021 [P] 文档同步：website/zh/docs/api.md 与 website/docs/api.md 补 trace 节（回传通道/时间线端点/脱敏承诺，对齐 contracts/trace-api.md）；docs/CliGuide.md 或部署文档提及「响应里的 traceId 用于报障定位」
- [ ] T022 [P] 更新 CLAUDE.md 审计相关段落：补 trace_id 列与「一次消息处理=一个 trace」口径一句话（SQLite 核心表小节）
