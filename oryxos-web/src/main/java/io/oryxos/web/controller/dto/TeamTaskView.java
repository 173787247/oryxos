...
public record TeamTaskView(
    String goal, String coordinator, String planRaw, List<WorkerView> workers, String summary) {
  ...
  public static TeamTaskView from(TeamTaskResult r) {
    List<WorkerView> workers =
        r.workers().stream()
            ...
            .toList();
    return new TeamTaskView(r.goal(), r.coordinator(), r.planRaw(), workers, r.summary());
  }
